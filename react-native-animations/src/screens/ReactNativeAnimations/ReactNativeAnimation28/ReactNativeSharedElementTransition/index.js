...
const timings = [...Array(numberOfLocations).keys()].map(
      ...
      >
        <Transition shared="marsPlanet">
          <Image
            ...
            style={styles.marsPlanetScreen1}
          />
        </Transition>
      </Animatable.View>
    ...
    <View style={styles.container}>
      <View style={{ position: "relative" }}>
        <Transition shared="marsPlanet">
          <Image
            source={require("./assets/mars_planet.png")}
            style={styles.marsPlanetScreen2}
            onLayout={(e) => {}}
          />
        </Transition>
        ...
        {coordinates.map(({ x, y }, i) => {
          return (
            <TouchableWithoutFeedback
              onPress={() =>
                navigation.navigate("Screen3", { coordinates: { x, y } })
              }
    ...
    <View style={styles.container}>
      <View
        style={{
          position: "relative",
          transform: [
            { translateX: -x * ratio + bigPlanet / 2 },
            { translateY: -y * ratio + bigPlanet / 2 },
          ],
        }}
      >
        <Transition shared="marsPlanet">
          <Image
            source={require("./assets/mars_planet.png")}
            style={styles.marsPlanetScreen3}
          />
        </Transition>
      </View>
      <Animatable.View
...
export default class ReactNativeSharedElementTransition extends React.Component {
  state = {
    isReady: false,
  };

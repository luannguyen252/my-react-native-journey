...
import styles from "./styles/rn-swipe-button-styles";

import SwipeButton from "rn-swipe-button";

export default function ReactNativeSwipeButtonExample() {
      ...
      <SafeAreaView>
        <View style={styles.container}>
          ...
          <View style={{ flexDirection: "row", alignItems: "center" }}>
            ...
            />
            <View style={{ marginLeft: 15, width: 150, height: 32 }}>
              <Button
                onPress={() => setDisableCBButton(!disableCBButton)}

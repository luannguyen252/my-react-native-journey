      ...
      <View style={{ backgroundColor: "#37465c" }}>
        ...
        {this.state.show ? (
          <Image source={{ uri: "tumblrblur" }} style={styles.menu}>
            <Animated.View
              style={[styles.menuItem1, { left: this.state.shift }]}
            >
              <Image
                style={styles.menuImg}
                source={{ uri: "tumblr-text" }}
              ></Image>
            ...
            >
              <Image
                style={styles.menuImg}
                source={{ uri: "tumblr-photo" }}
              ></Image>
              <Text style={styles.menuText}>Photo</Text>
            </Animated.View>
            <Animated.View
              style={[styles.menuItem3, { left: this.state.shift }]}
            >
              <Image
                style={styles.menuImg}
                source={{ uri: "tumblr-quote" }}
              ></Image>
            ...
            >
              <Image
                style={styles.menuImg}
                source={{ uri: "tumblr-link" }}
              ></Image>
              <Text style={styles.menuText}>Link</Text>
            </Animated.View>
            <Animated.View
              style={[styles.menuItem5, { left: this.state.shift }]}
            >
              <Image
                style={styles.menuImg}
                source={{ uri: "tumblr-chat" }}
              ></Image>

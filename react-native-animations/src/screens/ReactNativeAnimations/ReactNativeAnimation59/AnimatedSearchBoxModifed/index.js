...
export default class AnimatedSearchBoxModifed extends Component {
  state = {
    width: 0,
...
AnimatedSearchBoxModifed.defaultProps = {
  height: 48,
  borderRadius: 48,
  searchIconColor: "rgba(0, 0, 0, 0.7)",
  searchIconSize: 20,
...
AnimatedSearchBoxModifed.propTypes = {

...
const images = [
  ...
  {
    url: require("./images/2.jpeg"),
    text: "TRAVEL",
  },
  {
    url: require("./images/3.jpeg"),
    text: "ROAD",
  },
  {
...
export default class ReactNativeAnimatedMenu extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      animatedTopMenuMargin: new Animated.Value(
  ...
  openTopMenu() {
    Animated.parallel([
      Animated.timing(this.state.animatedContentScaleY, {
        toValue: 0.8,
        easing: Easing.cubic,
        duration: 500,
      }),
      Animated.timing(this.state.animatedContentScaleX, {
        toValue: 0.8,
        easing: Easing.cubic,
        duration: 500,
      }),
      Animated.timing(this.state.animatedTopMenuMargin, {
        toValue: 20,
        easing: Easing.cubic,
        duration: 500,
      }),
  ...
  //   const scaleFactor =
  //     source.width / (this.state.viewWidth * this.state.imageSizeCoef);
  ...
  render() {
    ...
    return (
      <LinearGradient colors={["#B453FE", "#71A7ED"]} style={styles.container}>
        <Animated.View
          style={{ flex: 1, marginTop: this.state.animatedTopMenuMargin }}
        >
        ...
        <Animated.View
          style={[
            ...
            { transform: [{ scaleX: this.state.animatedContentScaleX }] },
          ]}
        >
          <Animated.View
            style={[
              styles.headerContainerStyle,
              { transform: [{ scaleY: this.state.animatedContentScaleX }] },
            ]}
          >
          ...
          <Animated.View
            style={[
              styles.content,
              { transform: [{ scaleY: this.state.animatedContentScaleY }] },
            ]}
          >
            <ScrollView>
                ...
                return (
                  <Animated.View
                    ...
                    style={{
                      ...
                      height: this.getCardContainerHeight(image.url),
                      marginBottom: 30,
                    }}
                  >
                    <Animated.View
                    ...
                    >
                      <Text style={styles.imageLabelStyle}>{image.text}</Text>
                      <Icon
                    ...
                    >
                      <LinearGradient
                        colors={["#CDFCDA", "#B5F5E3"]}
                        start={{ x: 0.0, y: 0.25 }}
                        end={{ x: 0.5, y: 1.0 }}
                        style={styles.counterContainerStyle}
                      >
                        <Text style={styles.counterLabelStyle}>
                          {index + 1}
                        </Text>
                      </LinearGradient>
                    </Animated.Image>

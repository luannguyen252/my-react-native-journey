...
const MAIN_COLOR = colors.coolGray100;
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text style={styles.menuText}>SAMSUNG</Text>
          <Text style={styles.menuText}>GOOGLE PIXEL</Text>
          <Text style={styles.menuText}>HUAWEI</Text>
        </Animated.View>
        ...
        >
          ...
          >
            <Feather name="menu" size={40} color={colors.coolGray900} />
          </TouchableOpacity>
        </Animated.View>
      </Animated.View>
    );

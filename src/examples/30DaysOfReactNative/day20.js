    ...
    const list = listData.list.map((elem, index) => {
      return (
        <View
          ref={"list" + index}
          key={index}
          style={[styles.reminderList, { opacity: elem.selected ? 0.5 : 1 }]}
        >
          <TouchableHighlight
            underlayColor="transparent"
            style={[
              styles.check,
              { borderColor: elem.selected ? listData.theme : "#c6c6c6" },
            ]}
          ...
          >
            <View
              style={
                elem.selected
                  ? [styles.fill, { backgroundColor: listData.theme }]
                  : null
              }
            ></View>
          </TouchableHighlight>
  ...
  render() {
    return (
      <View style={styles.container}>
        <Image source={{ uri: "desktop" }} style={styles.container}></Image>

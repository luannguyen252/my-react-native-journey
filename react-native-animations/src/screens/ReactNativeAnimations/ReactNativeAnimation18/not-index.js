...
const GRADIENTS = {
  upset: "rgb(231, 97, 97)",
  sad: "rgb(231, 97, 97)",
  neutral: "rgb(231, 97, 97)",
  smile: "rgb(231, 97, 97)",
  excited: "rgb(231, 97, 97)",
};

export default class ReactNativeAnimation18 extends PureComponent {
  state = {
    path: PATHS.neutral,
  ...
  render() {
    return (
      <LinearGradient gradient={this.state.background} style={styles.gradient}>
        ...
        <View style={styles.svgWrapper}>
          ...
          <View style={styles.feedbackWrapper}>
            {types.map((type, index) => (
              <TouchableOpacity
                key={type}
                onPress={() => this.interpolatePaths(type, index)}
              >
                <AntDesign

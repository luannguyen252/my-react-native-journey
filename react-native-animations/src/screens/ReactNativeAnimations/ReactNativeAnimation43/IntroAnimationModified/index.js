...
const dark = colors.coolGray900;
const light = colors.coolGray100;
const bg = colors.violet600;
...
export default class IntroAnimationModified extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const color = this.heightTransition.interpolate({
      inputRange,
      outputRange: ["#0F172A", "#0F172A", "#FFFFFF"],
    });

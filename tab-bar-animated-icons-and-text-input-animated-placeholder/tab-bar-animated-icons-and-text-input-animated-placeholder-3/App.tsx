...
function TabBarJsonIcon({ name, navigation }) {
  const lottieViewRef = React.useRef(null);

  // BEGIN: Lắng nghe sự kiện tabPress để kích play hiệu ứng của LottieView
  React.useEffect(() => {
  ...
  // END: Lắng nghe sự kiện tabPress để kích play hiệu ứng của LottieView

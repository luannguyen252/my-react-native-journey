...
export default class ReactNativeCodeVerification extends Component {
  state = {
    code: "",
    digitDisabled: false,
    clearDisabled: false,
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <TouchableOpacity
          style={styles.close}
          onPress={() => this.props.onCloseView()}
        >
          <Image
            ...
            style={[
              styles.icon,
              ,
              { tintColor: closeButtonColor || "#FF0000" },
            ]}
          />
        </TouchableOpacity>
          ...
          {empties.map((item) => (
            <View key={item.key} style={styles.digitView}>
              ...
              <View
                style={[
                  styles.redSpace,
                  { backgroundColor: spaceColor || "#FF0000" },
                ]}
              />
            </View>
          ))}

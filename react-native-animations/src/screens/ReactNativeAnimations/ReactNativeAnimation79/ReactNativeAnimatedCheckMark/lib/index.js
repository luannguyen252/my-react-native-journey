...
var CrossMarker = (function (_Component) {
  _inherits(CrossMarker, _Component);
  function CrossMarker() {
    var _ref;
    var _temp, _this, _ret;
    _classCallCheck(this, CrossMarker);
    for (
      ...
      (_ret =
        ((_temp =
          ((_this = _possibleConstructorReturn(
            this,
            (_ref =
              CrossMarker.__proto__ ||
              Object.getPrototypeOf(CrossMarker)).call.apply(
              _ref,
              [this].concat(args)
            )
          )),
          _this)),
        (_this.toCross = function () {
          var onMarkPress = _this.props.onMarkPress;

          if (typeof onMarkPress === "function") onMarkPress();
          _this.startAnimation(1);
        }),
        (_this.toMark = function () {
          var onCrossPress = _this.props.onCrossPress;
        ...
        (_this.renderLine = function (angle, offset) {
  ...
  _createClass(CrossMarker, [
    ...
    {
      key: "startAnimation",
      value: function startAnimation(target) {
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            _reactNative.View,
            {
              style: [styles.container, { height: height, width: height * 2 }],
...
CrossMarker.propTypes = {
  ...
  onCrossPress: _react.PropTypes.func,
  onMarkPress: _react.PropTypes.func,
  onCrossTransformed: _react.PropTypes.func,
  onMarkTransformed: _react.PropTypes.func,
};

...
const { Component, ListView, View, Text, Image, TouchableOpacity, LinkingIOS } =
  React;
  ...
  render() {
    ...
    const company = this.props.company ? (
      <View>
        ...
        <Text style={theme.textBlock}>{this.props.company}</Text>
      </View>
    ) : null;
    ...
    return (
      <View>
        ...
        <Text style={theme.title}>
          About {this.props.speaker.split(" ")[0]}:
        </Text>

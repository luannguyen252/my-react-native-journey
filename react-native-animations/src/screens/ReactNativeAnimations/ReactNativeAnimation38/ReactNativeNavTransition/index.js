...
const MY_IMAGE = require("../../../../assets/memoji/memoji-8.png");
const closeItems = [0, 1];
const burgerItems = [0, 1, 2];
const NAVIGATION_ITEMS = ["Home", "Favourite", "Chat", "Profile", "Settings"];
const ANIMATION_DELAY = 500;

export default class ReactNativeNavTransition extends Component {
  constructor(props) {
    super(props);
      ...
      <View>
        {closeItems.map((i) => {
          ...
          const bg = this.closeAnimations[i].interpolate({
            ...
            outputRange: ["#9CA3AF", "#111827", "#9CA3AF"],
          });
  ...
  render() {
    ...
    const bgColor = this.state.animateBg.interpolate({
      ...
      outputRange: ["transparent", "#7C3AED", "#7C3AED"],
    });
        ...
        >
          ...
          >
            {NAVIGATION_ITEMS.map((item, index) => (
              <Text key={index} style={styles.buttonStyle}>
                {item}
              </Text>
            ))}
          </View>

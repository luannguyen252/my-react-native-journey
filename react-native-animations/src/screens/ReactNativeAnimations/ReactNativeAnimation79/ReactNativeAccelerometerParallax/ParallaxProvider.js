...
exports.ParallaxProvider = function (_a) {
  ...
  var _b = [
      react_native_reanimated_1.useSharedValue(0),
      react_native_reanimated_1.useSharedValue(0),
    ],
    posX = _b[0],
    posY = _b[1];
  ...
  return (
    <AccelerometerContext.Provider value={{ posX: posX, posY: posY }}>
      {children}
...
exports.useParallax = function (config) {
  var sensitivity =
    (config === null || config === void 0 ? void 0 : config.sensitivity) || 1;
  var _a = react_1.useContext(AccelerometerContext),
    posY = _a.posY,
    posX = _a.posX;

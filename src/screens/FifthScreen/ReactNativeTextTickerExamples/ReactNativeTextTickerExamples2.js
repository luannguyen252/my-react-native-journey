...
export default class ReactNativeTextTickerExamples2 extends PureComponent {
  renderTresholdExample = () => {
    ...
    return (
      <View>
        ...
        <View style={[styles.shouldAnimateTresholdContainer]}>
          <TextTicker shouldAnimateTreshold={overlayWidth}>{text}</TextTicker>
          <View
            style={[
              styles.overlayView,
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Spacer />
        <TextTicker>This fits in its container and wont scroll</TextTicker>
        <Spacer />
        <TextTicker>

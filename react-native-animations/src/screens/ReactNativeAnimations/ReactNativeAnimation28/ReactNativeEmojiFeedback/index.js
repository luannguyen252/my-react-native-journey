...
export default class ReactNativeEmojiFeedback extends React.Component {
  constructor(props) {
    super(props);
        ...
        <View style={styles.wrap}>
          ...
          <View style={styles.reactions}>
            {REACTIONS.map((reaction, idx) => {
              ...
              let colorOutputRange = ["#9CA3AF", "#111827", "#9CA3AF"];

              if (u - 20 < 0) {
                inputRange = [u, u + 20];
                scaleOutputRange = [0.25, 1];
                topOutputRange = [10, 0];
                colorOutputRange = ["#111827", "#9CA3AF"];
              }
              ...
              if (u + 20 > END) {
                ...
                topOutputRange = [0, 10];
                colorOutputRange = ["#9CA3AF", "#111827"];
              }

      ...
      <View style={styles.verticalContainer}>
        ...
        <View style={styles.volumeControlContainer}>
          <View style={styles.volumeControl}>
            <VolumeView
              onVolumeControlStateChange={this.volumeControlChanged}
            />
          </View>
        </View>
        ...
        <View style={styles.horizontalContainer}>
          <SoundBox
            ...
            volume={0.4}
            fileName="Wind"
            title="Let the Wind Pass!"
            style={styles.leftOne}
          />
          <SoundBox
            ref={(instance) => {
              this.thunder = instance;
            }}
            name="Thunder"
            volume={0.3}
            fileName="Thunder"
            title="Let the Thunder shout!"
            style={styles.rightOne}
          />
        </View>
      </View>
    );

...
export const ExpandableListView: React.FC<Props> = ({
  data,
  innerItemLabelStyle,
  renderItemSeparator,
              ...
              <Animated.Image
                source={
                  customChevron !== undefined
                    ? customChevron
                    : chevronColor !== undefined && chevronColor === "white"
                    ? white_chevron
                    : black_chevron
                }
                resizeMethod="scale"
                ...
                style={[
                  itemImageIndicatorStyle,
                  animated === undefined || (animated !== undefined && animated)
  ...
  return (
    <>
      {animated &&
        data.length > 0 &&
        state.isMounted[data.length - 1] === undefined &&
        ...
        style={[
          ...
          { ...ExpandableListViewStyles },
          {
            height:
              ...
              state.isMounted[data.length - 1] === undefined
                ? 0
                : ExpandableListViewStyles?.height !== undefined
                ? ExpandableListViewStyles?.height
                : "auto",
          },
        ]}
      >

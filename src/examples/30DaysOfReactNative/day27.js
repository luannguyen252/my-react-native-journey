...
export default class extends Component {
  constructor() {
    ...
    this.state = {
      color: [
        [
          "rgba(32,138,246,0.9)",
          "rgba(32,138,246,0.92)",
          "rgba(32,138,246,0.95)",
        ],
        [
          "rgba(32,138,246,0.92)",
          "rgba(32,138,246,0.95)",
          "rgba(32,138,246,0.98)",
        ],
        [
          "rgba(32,138,246,0.96)",
          "rgba(32,138,246,0.98)",
          "rgba(32,138,246,1)",
        ],
      ],
      msg: [
        "An iMessage Gradient effect",
        "Color should change by scroll pageY",
        "testing...",
      ],
    };
  }
  ...
  _changeColor = (index) => {
    ...
    UIManager.measure(handle, (x, y, width, height, pageX, pageY) => {
      ...
      let colors = [
        "rgba(32,138,246," + initOpacity + ")",
        "rgba(32,138,246," + (initOpacity + 0.05) + ")",
        "rgba(32,138,246," + (initOpacity + 0.1) + ")",
      ];
  ...
  render() {
      ...
      return (
        <LinearGradient
          ...
          style={[
            ...
            { top: Util.size.height - 30 - (total - index) * 50 },
          ]}
        >
    ...
    return (
      ...
      >
        <View style={{ height: 2 * Util.size.height }}>{linears}</View>
      </ScrollView>
    );
  }
}

...
export default function ChatHeadsExample(): React.ReactElement {
  return (
    <View style={styles.chatHeadContainer}>
      <ChatHeads>
        <View style={[styles.head, { backgroundColor: "#DC2626" }]} />
        <View style={[styles.head, { backgroundColor: "#F59E0B" }]} />
        <View style={[styles.head, { backgroundColor: "#10B981" }]} />
        <View style={[styles.head, { backgroundColor: "#3B82F6" }]} />
        <View style={[styles.head, { backgroundColor: "#4F46E5" }]} />
        <View style={[styles.head, { backgroundColor: "#7C3AED" }]} />
        <View style={[styles.head, { backgroundColor: "#DB2777" }]} />
      </ChatHeads>
    </View>
  );
}

...
import { BLOB_TRANSITION_MAX_INDEX } from "./types";
...
const BlobContent = ({ animation, component }: Props) => {
  const containerStyle = useMemo(() => {
    ...
    translateXOutputeRange[BLOB_TRANSITION_MAX_INDEX] =
      translateXOutputeRange[0];
    translateYOutputeRange[BLOB_TRANSITION_MAX_INDEX] =
      translateYOutputeRange[0];
  ...
  return <Animated.View style={containerStyle}>{component}</Animated.View>;
};
